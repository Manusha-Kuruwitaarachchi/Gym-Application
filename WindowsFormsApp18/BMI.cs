...
namespace WindowsFormsApp18
{
    public partial class BMI : Form
    {
        ...
        {
            userregistar u = new userregistar();
            u.MdiParent = this;
            u.Show();
        ...
        private void tricepWorkOutToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void findMyPaymentToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Cost c = new Cost();
            c.Show();
        }
